		...
		<div className={containerClasses} {...props}>
			<div className="p-4">
				<div className="flex justify-between items-center mb-4">
					<h2 className="text-[#5750E3] text-sm font-bold select-none">{text}</h2>
					{showResetButton && (
						<button 
				...
				<div>
					<div className="w-full bg-[#E8EDF5] border border-[#CDCAF7] rounded-md relative overflow-hidden" style={{ minHeight: '420px', height: 'auto' }}>
						{children}
					</div>
				</div>
			</div>
